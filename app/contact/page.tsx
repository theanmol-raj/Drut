...
import demo from "@/assets/contact/Demo.svg";
...
function page({}: Props) {
  const data = [
    ...
    },
    {
      ...
      c2a: "",
      c2at: "+91 (832)-515-4129",
    },
    {
      icon: chat,
      heading: "Live Chat",
      text: "Chat with drut.ai Expert",
      c2a: "",
      c2at: "Currently Unavailable",
    },
    {
      icon: demo,
      heading: "Request a Demo",
      text: "Book with a Drut expert",
      c2a: "",
      c2at: "info@drut.ai",
    },
  ];
    ...
    <main>
      <section className=" bg-hero">
        <div className="flex flex-col  max-w-7xl mx-auto justify-center items-center py-24 md:py-28 lg:py-44">
          <p className=" text-gray-400 font-semibold pt-1">Contact Us</p>
          <h1 className=" font-bold text-7xl text-white pt-2">We’d love to</h1>
          ...
          <p className=" text-gray-400 py-4 text-center">
            Our team is happy to connect and answer any of your questions.
          </p>
          <div className=" grid grid-cols-2 gap-6 md:gap-8 md:grid-cols-4 mt-16">
            {data?.map((x: any, y: number) => (
              <div key={y} className=" bg-black/50 p-8 rounded-2xl relative">
                <img src={x.icon?.src} className="mb-6" />
                <div className="py-6">
                  <h1 className=" font-semibold text-2xl text-white">
                    {x.heading}
                  </h1>
                  <p className=" font-light text-lg text-gray-300">{x.text}</p>
                </div>
                <button className=" w-full text-center text-white absolute bottom-4">
                  {x.c2at}
                </button>
              </div>
            ))}
          ...
          <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
            ...
            <div className="">
              ...
              <div className="mt-8">
                <button className="uppercase text-sm font-bold tracking-wide bg-cyan-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                  Send Message
                </button>
              </div>
            </div>
